...
class LevelEventPage extends HookWidget {
  ...
  PageController pageController = PageController(initialPage: 0, viewportFraction: 0.68);
  @override
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(fontSize: 14, fontStyle: FontStyle.normal, fontWeight: FontWeight.bold),
                    ),
                    Container(
