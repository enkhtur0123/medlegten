...
class VideoSubtitle extends BaseVideoSubtitlePage {
  const VideoSubtitle(VideoPlayerController videoPlayerController,
      List<CParagraph> paragraph, SubtitleWordCallback callback,{Key? key, bool? isBookMark,Function? bookMark})
      : super(videoPlayerController, paragraph,
            pwordCallback: callback, key: key,isBookMark: true,bookMark: bookMark);
