...
class _$ArticleTearOff {
  ...
  _Article call(String typeId, String typeName, List<ArticleItem> articles) {
    return _Article(
      typeId,
      typeName,
      articles,
...
abstract class $ArticleCopyWith<$Res> {
  ...
  $Res call({String typeId, String typeName, List<ArticleItem> articles});
}
...
class _$_Article implements _Article {
  _$_Article(this.typeId, this.typeName, this.articles);
  ...
  @override
  String toString() {
    return 'Article(typeId: $typeId, typeName: $typeName, articles: $articles)';
  }
...
abstract class _Article implements Article {
  factory _Article(String typeId, String typeName, List<ArticleItem> articles) =
      _$_Article;
