...
import 'dart:ui';
import 'package:medlegten/custom/BorderBox.dart';
          ...
          Column(
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('алгасах', style: TEXT_THEME_DEFAULT.headline1,)
                  ],
                ),
              ),
              addVerticalSpace(80),
              Padding(
                  ...
                  child: Text('Та төрсөн он сар өдрөө оруулна уу', style: TEXT_THEME_DEFAULT.headline2,),
              ),
              addVerticalSpace(10),
              Container(
                height: 52,
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: const Icon(Icons.date_range_outlined, color:  colorPrimary,),
                    filled: true,
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TEXT_THEME_DEFAULT.headline3, textAlign: TextAlign.center,
                ),
              )
            ],
          )
