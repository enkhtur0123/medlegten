...
import 'package:medlegten/models/Landing/course_units_info.dart';
...
import 'package:medlegten/pages/CoursePages/Unit_conversationVideo/module_conversationVideo.dart';
...
import 'package:medlegten/pages/CoursePages/Unit_mixedVideo/module_mixedVideo.dart';
import 'package:medlegten/pages/CoursePages/Unit_progressExam/module_progressExam.dart';
...
import 'package:medlegten/pages/CoursePages/course_unite_module_list.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute(path: '/unit_module_conversationvideo', page:ModuleConversationVideoPage),
